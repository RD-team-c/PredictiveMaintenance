...
namespace PredictiveMaintenance
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\jeric\OneDrive\code\Microsoft\ML\PredictiveMaintenance\ai4i+2020+predictive+maintenance+dataset\ai4i2020.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"Type", @"Type", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.1,LabelColumnName=@"Machine failure",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Machine failure"))      
